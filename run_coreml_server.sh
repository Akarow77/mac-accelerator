...
ONNX="${ONNX:-$REPO_ROOT/models/big_driving_supercombo.onnx}"
METADATA="${METADATA:-$REPO_ROOT/models/big_driving_supercombo_metadata.pkl}"
PORT="${PORT:-8066}"
...
if [[ "${MAC_ACCELERATOR_LOCAL_TEST:-1}" == "1" ]]; then
  MAC_ENDPOINT="::1"
