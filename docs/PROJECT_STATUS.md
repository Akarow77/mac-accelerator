...
describe the original research checkout, not tools shipped in this extraction.
...
artifacts described in the [original setup guide](https://github.com/Akarow77/sunnypilot/blob/mac-accelerator-v0.2.2/tools/mac_accelerator/README.md). It is not a self-contained
